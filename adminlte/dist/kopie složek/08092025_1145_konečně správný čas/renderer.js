...
// fallback – když se nepodaří čas, dej lineární +1s od 0 (ať to aspoň jede)
  ...
  // místo původního new Date(tms)
    time: Number(tms),                // jen číslo v ms
    timeStr: d.timeStr || d.TIME || d.timestamp || "00:00:00",  // ← pevně přeneseme text

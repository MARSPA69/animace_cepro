...
def convert_coordinates(lat_raw, lng_raw):
    ...
    try:
        ...
        # Data jsou pravděpodobně v mikrostupních (microdegrees)
        # nebo v nějakém jiném formátu, který potřebuje dělení
        
        # Možnost 1: Data jsou v mikrostupních (microdegrees)
        # 500436933 -> 50.0436933 (dělení 10^7)
        if lat_raw > 100000000:  # Větší než 100 milionů
            lat = lat_raw / 10000000.0
            lng = lng_raw / 10000000.0
        # Možnost 2: Data jsou v nějakém jiném formátu
        elif lat_raw > 10000000:  # Větší než 10 milionů
